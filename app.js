...
app.use('/js/lib', express.static(path.join(__dirname, 'node_modules/stupid-table-plugin'), { maxAge: 31557600000 }));
...
app.post('/comment', passportConfig.isAuthenticated, homeController.postComment);
...
app.get('/auth/snapchat', homeController.snap)
